        ...
        return $schema
            ->components([
                ...
                Section::make('Medias')->schema([
                    SpatieMediaLibraryFileUpload::make('image')->label('Image principale')->collection('image')->conversion('thumb')->responsiveImages()
                        ->imageEditor()->imageEditorAspectRatios([null, '16:9']),

                    SpatieMediaLibraryFileUpload::make('photos')->collection('photos')->multiple()->reorderable()->conversion('small-thumb')->responsiveImages()->panelLayout('grid')->itemPanelAspectRatio(1 / 1)->columnSpanFull()
                        ->imageEditor(),
